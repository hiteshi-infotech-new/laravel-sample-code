         ...
         serverSide: true,
         ajax: {
         url: SITEURL + "/product-list",//SITEURL var define in head (tableapp.blade)
         type: 'GET',
         },
         columns: [
         ...
         $('#selectId select').val(data.category_id);
         $('#product_code').val(data.product_code);
         $('#price').val(data.price);
         $('#description').text(data.description);
         $('#description').val(data.description);
         $('#is_feature').val(data.is_feature);
